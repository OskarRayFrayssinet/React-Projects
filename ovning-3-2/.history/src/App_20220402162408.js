...
function App() {
  ...
  return (
    <div className="App">
      <TheaterText insultObject={returnRandomInsult()} />
      <KlickButtonOption buttonOptionType="openInsults" />
      <KlickButtonOption buttonOptionType="generateRandomInsult" />
      <KlickButtonOption buttonOptionType="buttonNotFound" />
    </div>
  );
}
